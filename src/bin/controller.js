...
export async function main(ns) {
    ...
    while (true) {
        ...
        if (ctrl.syscallPid !== 0 && ns.isRunning(ctrl.syscallPid)) {
            ...
            //     factionRep: ctrl.factionRep,
            //     augFacts: ctrl.augFacts,
            // }));
            ...
            //ns.print("ctrl.augCandidates: " + JSON.stringify(ctrl.augCandidates));
...
// Draw controller UI
async function drawUI(ns, CFG, ctrl, best, mode, target, hack, formulas) {
    ns.clearLog();
